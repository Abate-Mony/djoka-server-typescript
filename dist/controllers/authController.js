...
import { BadRequestError, InterserverError, UnauthenticatedError, } from "../errors/customErrors.js";
// import User from "../models/userModel.js";
import { setCookies } from "../utils/cookieUtils.js";
import { comparePassword, hashPassword } from "../utils/passwordUtils.js";
// import { transporter } from "../utils/sendMailUtils.js";
import { Accountant, Admin, Driver, Parent, Principal, Student, Teacher, User, } from "../models/baseUserModel.js";
...
export const register = async (req, res) => {
    ...
    try {
        ...
        throw new InterserverError("something went wrong when creating your account please try again later");
    }
};
